...
$possible_plugin_locations = array(
	...
	'F:\xampp\htdocs\wgcweb6\wp-content\plugins\wp-optimize\cache',
);
...
if (false === $plugin_location) {
	...
	if (strcasecmp('http://localhost/wgcweb6/', $protocol . '://' . $host . $request_uri) === 0) {
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', 'F:\xampp\htdocs\wgcweb6\wp-content\plugins\wp-optimize\cache/extensions');
}
